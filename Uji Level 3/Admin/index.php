...
require '../koneksi.php';
$barang = query(
'SELECT stockbarang.id,stockbarang.nama,stockbarang.stock AS stockbarang, stockbarang.harga, stockbarang.gambar, SUM(belibarang.stock) AS belistock
FROM stockbarang LEFT JOIN belibarang ON stockbarang.id = belibarang.barang_id
GROUP BY stockbarang.id
ORDER BY Count(belibarang.barang_id) DESC
'
);
?>
                ...
                <div class="row header m-0 p-0">
                    ...
                    <div class="col-md-8">
                        <div class="input-group flex-nowrap search  mt-2 h-75">
                            <input type="text" class="form-control h-100 filter" placeholder="Ex makanan ringan" id="filter" data-id="3" aria-label="Recipient's username" aria-describedby="button-addon2" autocomplete="off">
                                ...
                                <?php foreach ($barang as $key => $brg) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="hapus.php?id=<?= $brg['id'] ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
