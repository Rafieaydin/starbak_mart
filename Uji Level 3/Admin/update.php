...
FROM stockbarang LEFT JOIN belibarang ON stockbarang.id = $id
                    ...
                    <?php foreach ($barang as $brg) { ?>
                        ...
                        <div class="row">
                            <div class="row mt-4 mb-2">
                                ...
                                <input type="text" name="gambar" class="col-md-9" value="<?= $brg['gambar'] ?>">
                            </div>
                            <div class="row mt-2 mb-2">
                                <label for="" class="col-md-3">Nama Barang</label>
                                <input type="text" name="nama" class="col-md-9" value="<?= $brg['nama'] ?>">
                            </div>
                            <div class="row mt-2 mb-2">
                                <label for="" class="col-md-3">Stock</label>
                                <input type="text" name="stock" class="col-md-9" value="<?= $brg['stockbarang'] ?>">
                            </div>
                            <div class="row mt-2 mb-4">
                                <label for="" class="col-md-3">Harga</label>
                                <input type="text" name="harga" class="col-md-9" value="<?= $brg['harga'] ?>">
                            </div>
                        </div>
                    <?php } ?>
