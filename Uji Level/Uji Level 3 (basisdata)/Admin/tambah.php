        ...
        <div class="row">
            ...
            <div class="col-md-8  tambahTable1   mt-2 ms-3">
                <form action="" method="POST">
                    ...
                    <a href="index.php" class="btn btn-danger button1 btn-sm mb-3 "><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> kembali</a>
                    <button class="btn btn-success btn-sm mb-3" type="submit" name="submit">tambah</button>
                </form>
            </div>
