        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <form action="" method="POST" id="form">
                    <button type="submit" class="btn me-2 ms-2 btn-outline-primary  mt-2 d-block w-100 " name="beli" id="tambah">BAYAR</button>
                </form>
            </div>
            <!-- end keranjang -->
                ...
                <div class="row header m-0 p-0">
                    ...
                    <div class="col-md-8">
                        <div class="input-group flex-nowrap search mr-3 mt-2 h-75">
                            <input type="text" class="form-control h-100" placeholder="Cari barang" id="search" aria-label="Recipient's username" aria-describedby="button-addon2" autocomplete="off">
                    ...
                    <div class="row">
                        <?php foreach ($barang as $brg) { ?>
                            <div class="col-md-3" onclick="tambahBarang('val.<?= $brg['id'] ?>')">
                                <div class="card mt-2 card rounded  mb-2 ml-3 mr-1 mt-2 drag <?= ($brg['stock'] < 1) ? 'bg-danger' : '' ?>">
                                    <img src=" <?= $brg['gambar'] ?>" class="card-img-top" alt="">
                                    <div class="card-body ">
                                        <p class="<?= ($brg['stock'] < 1) ? 'text-white' : '' ?>"><?= $brg['nama'] ?></p>
                                        <p class="<?= ($brg['stock'] < 1) ? 'text-white' : '' ?> text-harga"><?= rupiah($brg['harga']) ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
